...
* we learned that data.frames were vectors, so that we have consistent data down a column
...
## You can add a vector to the data frame
...
* we can also interrogate the data.frame for info about itself
...
* do the basic data a types reported make sense?
